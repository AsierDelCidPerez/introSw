...
int main(void)
{
    ...
    int dice1, dice2, sum;
	srand(clock()); // Establecemos una seed en función de la hora para una conveniente aleatorización
    
    // Algoritmo del programa
    // Primera parte del juego: si la suma de las caras de los 2 al ser lanzados es múltiplo de MULTIPLE_OF entonces gana:
    ...
    if(!(sum % MULTIPLE_OF)){
        ...
        // Fase 2 del juego: solo gana si la suma de los dos dados a lanzar es igual a la suma de los dos anteriores.
        dice1 = get_random_from_range(1, NFACES);
        dice2 = get_random_from_range(1, NFACES);
